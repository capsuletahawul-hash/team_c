...
function Footer(): React.JSX.Element {
  ...
  return (
    <footer
      dir={t.dir}
      className="bg-gradient-to-tr from-capsule-footer via-capsule-navy to-capsule-teal text-white pt-12 pb-6 px-8 mt-auto mt-12 border-t border-capsule-teal/20 font-sans"
    >
